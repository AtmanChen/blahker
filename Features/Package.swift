...
let package = Package(
	...
	targets: [
		...
		.target(
			name: "Features",
			dependencies: [.sca, .contentBlockerService]),
		.target(name: "ContentBlockerService", dependencies: [.dependencies]),
		.testTarget(
			name: "FeaturesTests",
			dependencies: ["Features", .sca]),
	])
...
extension Target.Dependency {
	static let sca = Self.product(name: "ComposableArchitecture", package: "swift-composable-architecture")
